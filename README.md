...
|-----|---------|-----------------------------------------------|------------------|
| **Nguyễn Hà Thu** | 2502340 | Phát triển Backend (Socket & Core Logic)      | • Phát triển hệ thống kết nối mạng thời gian (Socket Server & Socket Client)<br>• Thiết kế và cài đặt các lớp logic cốt lõi (Service, Observer Pattern)<br>• Xử lý nghiệp vụ và chức năng của User<br>• Tính năng nâng cao: Đấu giá tự động (Auto Bid), Gia hạn thời gian (Anti Sniping) |
