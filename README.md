...
- **Cập nhật Bid đấu giá theo thời gian thực**: Sử dụng BidSocketClient & BidPushServer
...
### 6️ Cấu Hình Server Address cho Client
...
- ✔️ **Design Patterns**: 
  ...
  - Singleton Pattern cho nhiều chức năng
...
- ✔️ **Biểu đồ đấu giá realtime**
  - Cập nhật ngay khi có bid mới
  - Toàn bộ client được cập nhập ngay lập tức mà không cần refresh
  - Trục x: thời gian, trục y: giá đấu hiện tại

#### 4. **Giao Diện Người Dùng**
- ✔️ **JavaFX UI**: Giao diện đẹp, responsive, dễ sử dụng
- ✔️ **23 Screens**: Đầy đủ chức năng cho cả 3 loại user
